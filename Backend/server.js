...
// Middleware
app.use(cors({
  origin: ['http://13.233.174.185:8055', 'http://13.233.174.185:8056'], // frontend and HR ports
...
pool.connect()
  .then(() => {
    ...
    initializeDatabase().then(() => {
      app.listen(port, () => {
        console.log(`🚀 Server running on http://13.233.174.185:${port}`);
        console.log(`📄 Offboarding Form: http://13.233.174.185:${port}/offboarding.html`);
        console.log(`📊 HR Offboarding Dashboard: http://13.233.174.185:${port}/hrOffboarding.html`);
      });
    });
  })
  .catch(err => {
